...
const ClickSlideShow = ({ Slide1Item }) => {
    ...
    return (
        <Fragment>
            <div id="clickContainer">
...

                    {
                        showSlide === 3 ?
                            <div className="InnerSlide">
                                ...
                                <div className="InnerSlideText">
                                    <p style={{color:"black"}}>{Slide1Item[3].name}</p>
                                    <span style={{color:"black"}}>{Slide1Item[3].span}</span>
                                </div>
                            </div>
                            : null
                    }
                ...
                <ul >
                    <li style={showSlide===0?{color:"white"}:null} onClick={() => showSlideHnadler(0)} >{Slide1Item[0].name}</li>
                    <li style={showSlide===0?{color:"white"}:null} onClick={() => showSlideHnadler(1)} >{Slide1Item[1].name}</li>
                    <li style={showSlide===0?{color:"white"}:null} onClick={() => showSlideHnadler(2)} >{Slide1Item[2].name}</li>
                    <li style={showSlide===0?{color:"white"}:null} onClick={() => showSlideHnadler(3)} >{Slide1Item[3].name}</li>
                    <li style={showSlide===0?{color:"white"}:null} onClick={() => showSlideHnadler(4)} >{Slide1Item[4].name}</li>
                </ul>
